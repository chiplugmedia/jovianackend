...
export async function sendRegistrationEmail(userData = {}) {
  ...
  const transporter = nodemailer.createTransport({
    ...
    port: smtpPort,
    secure: smtpPort === 465, // Must be true for Hostinger SSL (port 465)
    auth: {
  ...
  const mailOptions = {
    from: `"Jovia Network" <${process.env.EMAIL_FROM || process.env.SMTP_USER}>`,
            ...
            <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width:600px; width:100%; background-color:#0a0518; border-radius:24px; border:1px solid rgba(226,200,118,0.2); overflow:hidden;">
              ...
              <tr>
                <td align="center" style="background: linear-gradient(135deg, #0a0518 0%, #1e0933 50%, #0a0518 100%); padding:40px 30px; border-bottom:1px solid rgba(255,255,255,0.08);">
                  ...
                  <p style="color:#94a3b8; margin-top:10px; margin-bottom:0; font-size:15px; line-height:1.5;">
                ...
                <td style="padding:32px 30px;">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                    ...
                    <tr>
                      ...
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#ffffff; font-weight:700; font-size:14px; text-align:right;">${userData.fullname || "N/A"}</td>
                    </tr>

                    <tr>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#94a3b8; font-size:14px;">Email Address</td>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#ffffff; font-weight:700; font-size:14px; text-align:right;">${userData.email || "N/A"}</td>
                    </tr>

                    <tr>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#94a3b8; font-size:14px;">Phone Number</td>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#ffffff; font-weight:700; font-size:14px; text-align:right;">${userData.phone || "N/A"}</td>
                    </tr>

                    <tr>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#94a3b8; font-size:14px;">Plan Selected</td>
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#C726D4; font-weight:800; font-size:14px; text-align:right;">Jovia ${userData.plan || "Standard"}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="padding:12px 0; border-bottom:1px solid rgba(255,255,255,0.08); color:#ffffff; font-family:monospace; font-size:13px; text-align:right;">${userData.tx_ref || "N/A"}</td>
                    </tr>
